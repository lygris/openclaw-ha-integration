...
class OpenClawClient:
    ...
    def _format_entity_context(self, entity_context: list[dict[str, Any]]) -> str:
        ...
        lines = [
            "Home Assistant entity context with current live states.",
            ...
            "Reply naturally and briefly. Do not preface the answer with phrases like 'Based on the current context' or 'According to the data' unless the user explicitly asks for analysis.",
        ]
